...
Knowing the play type is crucial to understand the winning chance at a specific play, so with only 51 rows of missing data for the play_type, I cant complete row wise deletion here with losing too much data. 
